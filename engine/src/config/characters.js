...
export const CHARACTERS = [
  {
    key: 'lebron_james', name: 'LeBron James', kingdom: 'wei', position: 'forward', hp: 4, nbaId: '2544',
    skill: '全能 / 组织',
    archetype: '全能核心',
  ...
  {
    key: 'kobe_bryant', name: 'Kobe Bryant', kingdom: 'shu', position: 'guard', hp: 4, nbaId: '977',
    skill: '曼巴 / 绝杀',
    archetype: '终结型单打手',
  ...
  {
    key: 'stephen_curry', name: 'Stephen Curry', kingdom: 'shu', position: 'guard', hp: 3, nbaId: '201939',
    skill: '射程 / 三分雨',
    archetype: '三分爆发',
  ...
  {
    key: 'shaquille_oneal', name: "Shaquille O'Neal", kingdom: 'wu', position: 'inside', hp: 5, nbaId: '406',
    skill: '禁区 / 罚球',
    archetype: '内线巨兽',
  ...
  {
    key: 'tim_duncan', name: 'Tim Duncan', kingdom: 'wei', position: 'inside', hp: 4, nbaId: '1495',
    skill: '基本功 / 护框',
    archetype: '稳定基石',
  ...
  {
    key: 'kevin_durant', name: 'Kevin Durant', kingdom: 'shu', position: 'forward', hp: 3, nbaId: '201142',
    skill: '错位 / 干拔',
    archetype: '无差别单打',
  ...
  {
    key: 'dwyane_wade', name: 'Dwyane Wade', kingdom: 'shu', position: 'guard', hp: 4, nbaId: '2548',
    skill: '突破 / 造犯',
    archetype: '突破造杀伤',
  ...
  {
    key: 'chris_paul', name: 'Chris Paul', kingdom: 'wei', position: 'guard', hp: 3, nbaId: '101108',
    skill: '控场 / 抢断',
    archetype: '控场组织',
  ...
  {
    key: 'james_harden', name: 'James Harden', kingdom: 'shu', position: 'guard', hp: 3, nbaId: '201935',
    skill: '造犯 / 后撤步',
    archetype: '造犯规与爆发',
  ...
  {
    key: 'kawhi_leonard', name: 'Kawhi Leonard', kingdom: 'wu', position: 'forward', hp: 4, nbaId: '202695',
    skill: '死亡缠绕 / 沉默',
    archetype: '攻防一体',
  ...
  {
    key: 'kevin_garnett', name: 'Kevin Garnett', kingdom: 'wu', position: 'inside', hp: 4, nbaId: '708',
    skill: '怒吼 / 协防',
    archetype: '激情防守',
  ...
  {
    key: 'dwight_howard', name: 'Dwight Howard', kingdom: 'wu', position: 'inside', hp: 4, nbaId: '2730',
    skill: '篮板 / 盖帽',
    archetype: '篮板护筐',
  ...
  {
    key: 'ray_allen', name: 'Ray Allen', kingdom: 'qun', position: 'guard', hp: 3, nbaId: '951',
    skill: '底角 / 绝平',
    archetype: '定点射手',
  ...
  {
    key: 'shane_battier', name: 'Shane Battier', kingdom: 'qun', position: 'forward', hp: 3, nbaId: '2426',
  ...
  {
    key: 'manu_ginobili', name: 'Manu Ginobili', kingdom: 'qun', position: 'guard', hp: 3, nbaId: '1938',
    skill: '妖刀 / 奇袭',
    archetype: '第六人妖刀',
  ...
  {
    key: 'andre_iguodala', name: 'Andre Iguodala', kingdom: 'qun', position: 'forward', hp: 4, nbaId: '2738',
    skill: 'FMVP / 协防',
    archetype: '关键防守者',

...
export const CHARACTERS = [
  {
    key: 'lebron_james', name: 'LeBron James', cnName: '詹姆斯', voiceName: 'LeBron', nickname: '小皇帝', kingdom: 'wei', position: 'forward', hp: 4, nbaId: '2544',
    skill: '全能 / 组织',
    archetype: '全能核心',
  ...
  {
    key: 'kobe_bryant', name: 'Kobe Bryant', cnName: '科比', voiceName: 'Kobe', nickname: '黑曼巴', kingdom: 'shu', position: 'guard', hp: 4, nbaId: '977',
    skill: '曼巴 / 绝杀',
    archetype: '终结型单打手',
  ...
  {
    key: 'stephen_curry', name: 'Stephen Curry', cnName: '库里', voiceName: 'Curry', nickname: '萌神', kingdom: 'shu', position: 'guard', hp: 3, nbaId: '201939',
    skill: '射程 / 三分雨',
    archetype: '三分爆发',
  ...
  {
    key: 'shaquille_oneal', name: "Shaquille O'Neal", cnName: '奥尼尔', voiceName: 'Shaq', nickname: '大鲨鱼', kingdom: 'wu', position: 'inside', hp: 5, nbaId: '406',
    skill: '禁区 / 罚球',
    archetype: '内线巨兽',
  ...
  {
    key: 'tim_duncan', name: 'Tim Duncan', cnName: '邓肯', voiceName: 'Duncan', nickname: '石佛', kingdom: 'wei', position: 'inside', hp: 4, nbaId: '1495',
    skill: '基本功 / 护框',
    archetype: '稳定基石',
  ...
  {
    key: 'kevin_durant', name: 'Kevin Durant', cnName: '杜兰特', voiceName: 'Durant', nickname: '死神', kingdom: 'shu', position: 'forward', hp: 3, nbaId: '201142',
    skill: '错位 / 干拔',
    archetype: '无差别单打',
  ...
  {
    key: 'dwyane_wade', name: 'Dwyane Wade', cnName: '韦德', voiceName: 'Wade', nickname: '闪电侠', kingdom: 'shu', position: 'guard', hp: 4, nbaId: '2548',
    skill: '突破 / 造犯',
    archetype: '突破造杀伤',
  ...
  {
    key: 'chris_paul', name: 'Chris Paul', cnName: '保罗', voiceName: 'CP3', nickname: '保罗', kingdom: 'wei', position: 'guard', hp: 3, nbaId: '101108',
    skill: '控场 / 抢断',
    archetype: '控场组织',
  ...
  {
    key: 'james_harden', name: 'James Harden', cnName: '哈登', voiceName: 'Harden', nickname: '大胡子', kingdom: 'shu', position: 'guard', hp: 3, nbaId: '201935',
    skill: '造犯 / 后撤步',
    archetype: '造犯规与爆发',
  ...
  {
    key: 'kawhi_leonard', name: 'Kawhi Leonard', cnName: '卡哇伊', voiceName: 'Kawhi', nickname: '可怕', kingdom: 'wu', position: 'forward', hp: 4, nbaId: '202695',
    skill: '死亡缠绕 / 沉默',
    archetype: '攻防一体',
  ...
  {
    key: 'kevin_garnett', name: 'Kevin Garnett', cnName: '加内特', voiceName: 'KG', nickname: '狼王', kingdom: 'wu', position: 'inside', hp: 4, nbaId: '708',
    skill: '怒吼 / 协防',
    archetype: '激情防守',
  ...
  {
    key: 'dwight_howard', name: 'Dwight Howard', cnName: '霍华德', voiceName: 'Howard', nickname: '魔兽', kingdom: 'wu', position: 'inside', hp: 4, nbaId: '2730',
    skill: '篮板 / 盖帽',
    archetype: '篮板护筐',
  ...
  {
    key: 'ray_allen', name: 'Ray Allen', cnName: '雷阿伦', voiceName: 'Ray Allen', nickname: '雷神', kingdom: 'qun', position: 'guard', hp: 3, nbaId: '951',
    skill: '底角 / 绝平',
    archetype: '定点射手',
  ...
  {
    key: 'shane_battier', name: 'Shane Battier', cnName: '巴蒂尔', voiceName: 'Battier', nickname: '蝙蝠侠', kingdom: 'qun', position: 'forward', hp: 3, nbaId: '2426',
  ...
  {
    key: 'manu_ginobili', name: 'Manu Ginobili', cnName: '吉诺', voiceName: 'Manu', nickname: '妖刀', kingdom: 'qun', position: 'guard', hp: 3, nbaId: '1938',
    skill: '妖刀 / 奇袭',
    archetype: '第六人妖刀',
  ...
  {
    key: 'andre_iguodala', name: 'Andre Iguodala', cnName: '伊戈', voiceName: 'Iggy', nickname: 'FMVP', kingdom: 'qun', position: 'forward', hp: 4, nbaId: '2738',
    skill: 'FMVP / 协防',
    archetype: '关键防守者',
